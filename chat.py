    ...
    routing_prompt = [
        {
            ...
            "content": (
                ...
                "DELETE_ALL is ONLY for tasks/reminders -- NEVER use it for files, trash, or the recycle "
                "bin. 'Empty the trash', 'clear the trash', 'delete everything in the trash' always means "
                "FILE_OPERATION with action 'empty_trash', never DELETE_ALL, even though both mention "
                "'clear' or 'delete'.\n"
